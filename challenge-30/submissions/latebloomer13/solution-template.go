...
func SimulateWork(ctx context.Context, workDuration time.Duration, description string) error {
	...
	/////// don't understand what they want from me. so rework sometimes
    select {
...
func MyProcessItems(ctx context.Context, items []string) ([]string, error) {
...
//just copied, read, understood and pasted. rework in future. upd: just copy didn't work
